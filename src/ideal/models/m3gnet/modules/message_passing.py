    ...
    def forward(
        ...
        atom_mask = (
            ...
            * polynomial(
                ...
                self.threebody_cutoff,  # noqa: E501
            )
            * polynomial(
        ...
        index_map = torch.arange(torch.sum(num_edges).item()).to(edge_length.device)  # noqa: E501
        ...
        e_ij_tuda = scatter(
            ...
            dim=0,
            reduce="sum",
            dim_size=int(torch.sum(num_edges).item()),
        )
...
class AtomLayer(nn.Module):
    ...
    def forward(
        ...
        atom_attr_prime = scatter(
            ...
            edge_index[1],
            dim=0,
            dim_size=int(torch.sum(num_atoms).item()),  # noqa: E501
        )
