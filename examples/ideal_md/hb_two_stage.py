...
if __name__ == "__main__":
    ...
    parser.add_argument("--temperature_1", type=float, default=300.0)
    parser.add_argument("--md_steps_1", type=int, default=100000)
    parser.add_argument("--temperature_2", type=float, default=1800.0)
    parser.add_argument("--md_steps_2", type=int, default=100000)
