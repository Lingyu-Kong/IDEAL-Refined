...
def add_molecules(
    ...
    box_size = system.get_cell().diagonal()
...
if __name__ == "__main__":
    ...
    final_name = f"./particles/{nanoparticle_element}{final_np_size}-{promoter_element}{final_num_promoters}-{add_promoter_method}-{final_H2_pressure}atmH2-{final_N2_pressure}atmN2.xyz"
